...
exports.pageEvents=(req,res)=>{
    ...
    models.Event.find({},{title:true,description:true,createdAt:true,users:true,start:true,end:true}).skip(page*pagesize).sort({createdAt:-1}).limit(pagesize).populate("users","fullname email")
